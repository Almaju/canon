...
no files to install. Import any module with `use canon/std/TypeName` at
the top of your file — thematic sub-namespaces use the folder in the
path, e.g. `use canon/std/fs/File` or `use canon/std/time/Now`.
