...
level. The [Tour](../tour/hello.md) motivates; this section
defines.
...
dispatch, functions, ordering, modules, effects and async, compilation
and the ABI, and the Types-Only naming model.
